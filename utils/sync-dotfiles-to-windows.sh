...
sync_file "claude settings" "$repo_root/dotfiles/claude/.claude/settings.json" "$windows_home/.claude/settings.json"
...
sync_dir "herdr" "$repo_root/dotfiles/herdr/.config/herdr" "$windows_home/.config/herdr"
