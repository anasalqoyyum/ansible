...
import MousePointerPreview from "../../../components/MousePointerPreview.astro"
...
OpenTUI sends each value with [OSC 22](https://sw.kovidgoyal.net/kitty/pointer-shapes/), but it does not detect OSC 22
