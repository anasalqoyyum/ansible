...
This page covers the engine and loaded-sound playback. See [Streaming audio](/docs/application-apis/audio-streaming) for PCM or encoded byte sources and radio URLs. See [Audio capture and recording](/docs/application-apis/audio-capture) for input devices, Float32 PCM, and WAV files.
