...
Source branch, title, and target default to sensible values from git state. Always include `--with-default-reviewers` so the repository's configured default reviewers are added. Add `--draft` for work-in-progress or `--reviewer alice` for an additional reviewer.
...
- [headless / env vars](headless.md) — Config-free CI/container auth (BKT_TOKEN, BKT_HOST) and full env var reference

<!-- auto-generated by cmd/docgen — do not edit below this line -->

- [admin](admin.md) — Administrative operations for Bitbucket *(DC)*
- [auth](auth.md) — Manage Bitbucket authentication credentials
- [branch](branch.md) — Inspect and manage branches
- [commit](commit.md) — Work with commits
- [context](context.md) — Manage Bitbucket CLI contexts
- [extension](extension.md) — Manage bkt CLI extensions
- [issue](issue.md) — Work with Bitbucket Cloud issues *(Cloud)*
- [mcp](mcp.md) — Model Context Protocol server for agents
- [perms](perms.md) — Manage Bitbucket permissions *(DC)*
- [pipeline](pipeline.md) — Run and inspect Bitbucket Cloud pipelines *(Cloud)*
- [pr](pr.md) — Manage pull requests
- [project](project.md) — Work with Bitbucket projects *(DC)*
- [repo](repo.md) — Work with Bitbucket repositories
- [skill](skill.md) — Install and manage agent skills
- [status](status.md) — Inspect commit and pull request statuses
- [variable](variable.md) — Manage pipeline variables *(Cloud)*
- [webhook](webhook.md) — Manage Bitbucket webhooks
- [other](other.md) — api
