...
Tell the user the feature map drifts as the app changes, and that re-running this skill against the existing map is how it gets corrected. Suggest a cadence only if they ask.
