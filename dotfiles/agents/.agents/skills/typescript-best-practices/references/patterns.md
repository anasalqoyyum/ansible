...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; this file shows their TypeScript forms.
...
Validate once where data crosses in; trust parsed types inside.
